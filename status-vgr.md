...
- **Working paper category cleanup:** audit resources with `type: working-paper` — many are effectively papers or frameworks. Decide on a clean definition and reclassify as needed.
